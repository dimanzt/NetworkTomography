...
from my_lib_optimal_async_SDN_Straggler import *
...
Total_ReRouted_T = 0
UpdateTime_T = []
[OBJ_T, Deltah_T, H4, my_used_arcs_T, Max_Time_T, Total_Hop_T, Total_ReRouted_T, UpdateTime_T]= optimal_SDN_ILP(H,green_edges, K, demand_flows, w_l, w_h, Thrh, Thr,weights)
...
[OBJ, Deltah, H3, my_used_arcs, Max_Time, Total_Hop, Total_ReRouted, UpdateTime]= optimal_SDN_ILP(H,green_edges, K, demand_flows, w_l, w_h, Thrh, Thr, weights)
...
write_stat_SDN(path_to_stats,filename_stat,prob_edge,seed_random,alfa,
                          SumDelta,UpdateTime,Objective,Total_Hop,Max_Time,Min_Hops,Satisfied_Demand, #Number of flows which get re-routed ,Number of flows which get delayed ,OPTIMAL Objective
                          num_sim,
