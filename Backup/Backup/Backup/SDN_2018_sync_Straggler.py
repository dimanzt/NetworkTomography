...
from my_lib_optimal_sync_SDN_Straggler import *
...
Thrh = Thr
Total_ReRouted_T = 0
[OBJ_T, Deltah_T, H4, my_used_arcs_T, Max_Time_T, Total_Hop_T, Total_ReRouted_T,UpdateTime]= optimal_SDN_ILP(H,green_edges, K, demand_flows, w_l, w_h, Thrh, Thr, weights)
