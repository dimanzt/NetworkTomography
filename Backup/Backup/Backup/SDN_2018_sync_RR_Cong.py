...
from my_lib_optimal_sync_SDN_RR_Cong import *
...
[OBJ, Deltah, H3, my_used_arcs, Max_Time, Total_Hop, Total_ReRouted, MaxCong]= optimal_SDN_LP(H,green_edges, K, demand_flows, w_l, w_h, Thrh, Thr, weights)
