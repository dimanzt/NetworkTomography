...
#"""---------------------------------------------------------------------------------
#Diman Added for ISP with full-knowledge:
...
owned_nodes=[]
#optimal classico
#nodes_recovered_expected_optimal,edges_recovered_expected_optimal=optimal_expected_recovery(H2,green_edges,Gap)
...
while (routability_flag==False):
  #nodes_recovered_expected_optimal,edges_recovered_expected_optimal=optimal_expected_recovery(temp_graph_supply_2,green_edges,Gap)
  ...
  nodes_recovered_expected_optimal,edges_recovered_expected_optimal=optimal_expected_recovery_max_flow(temp_graph_supply_2,green_edges,Gap)
...
my_draw(temp_graph_supply_3,'Diman_expected_optimal_%d'%counter)
counter=counter+1
nodes_recovered_expected_optimal,edges_recovered_expected_optimal=optimal_expected_recovery(temp_graph_supply_3,green_edges,Gap)
while (routability_flag==False):
  #nodes_recovered_expected_optimal,edges_recovered_expected_optimal=optimal_expected_recovery(temp_graph_supply_3,green_edges,Gap)
  ...
  #nodes_recovered_expected_optimal,edges_recovered_expected_optimal=optimal_expected_recovery_max_flow(temp_graph_supply_3,green_edges,Gap)
  ...
  if node_selected not in repaired_nodes:
    ...
    if (temp_graph_supply_3.has_node(node_selected)):
...
#del H
#H8=nx.MultiGraph(nx.read_gml(path_to_graph))  #grafo supply
H10=nx.MultiGraph(H8)
#prepare_graph(H10)
merge_graphs(H10,D)
...
temp_graph_supply_shortest_based=nx.MultiGraph(H10)
...
print 'BIAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
...
while (routability_flag==False):
  ...
  #nodes_recovered_srt_optimal,edges_recovered_srt_optimal=optimal_expected_recovery(H3,green_edges,Gap)
  print 'Diman joooooooooooooooooooooooooon'
  print nodes_recovered_srt_optimal
