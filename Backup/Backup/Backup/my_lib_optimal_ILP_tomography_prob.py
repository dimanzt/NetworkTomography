...
def optimal_ILP_tomography_prob(my_path_comb,my_objects, Max_prob_Cost, My_probes, Cost_routing):
    Best_ILP_paths=[]
    ...
    #for mon in my_path_comb:
        ...
        #print mon.monitors
    """
    Best_ILP_paths, ILP_identifiable_links = ILP_solution_best_prob(my_path_comb, my_objects, Max_prob_Cost, My_probes, Cost_routing)
...
def ILP_solution_best_prob(my_path_comb, my_objects, Max_prob_Cost, My_probes, Cost_routing):
    Best_ILP_paths=[]
    ILP_identifiable_links=[]
    #########################GREEEDY BASED APPROACH###############################
    Best_greedy=0
