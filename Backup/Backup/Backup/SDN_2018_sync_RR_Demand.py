...
from my_lib_optimal_sync_SDN_RR_Demand import *
...
Total_ReRouted_T = 0
MaxCong_T = 0
[OBJ_T, Deltah_T, H4, my_used_arcs_T, Max_Time_T, Total_Hop_T, Total_ReRouted_T, MaxCong_T]= optimal_SDN_ILP(H,green_edges, K, demand_flows, w_l, w_h, Thrh, Thr, weights)
...
[OBJ, Deltah, H3, my_used_arcs, Max_Time, Total_Hop, Total_ReRouted, MaxCong, Satisfied_Demand]= optimal_SDN_LP(H,green_edges, K, demand_flows, w_l, w_h, Thrh, Thr, weights)
