...
from my_lib_optimal_LP_demand_loss import *
#from my_lib_optimal_LP_SDN import *
...
w_l = 100#0.001 #100
w_h = 200#0.002 #200
Thrh= len(arcs)*var_distruption #len(arcs)/2
Thr= Thrh*len(demand_flows)*0.8 
print 'Thr and Thrh: HEEEEEEEEEEEEEEEEEEEEEREEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE'
print Thr, Thrh
MaxCong = 1
[OBJ, Deltah, H3, my_used_arcs, MaxCong] = optimal_SDN_LP(H,green_edges, K, demand_flows, w_l, w_h, Thrh, Thr)
...
write_stat_SDN(path_to_stats,filename_stat,prob_edge,seed_random,alfa,
                          SumDelta,MaxCong,OBJ, #Number of flows which get re-routed ,Number of flows which get delayed ,OPTIMAL Objective
                          num_sim,
