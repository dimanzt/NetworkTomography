...
def optimal_SDN_Max(H,green_edges, K, demand_flows, w_l, w_h):
    ...
    my_altered_switches,my_used_arc, my_delta, my_theta =optimize_SDN_Max(H,nodes,demand_flows,arcs,capacity,K,inflow, demand_value, w_l, w_h)
...
def optimize_SDN_Max(H,nodes,demand_flows,arcs,capacity,K,inflow, demand_value, w_l, w_h):
