...
def optimal_SDN_ILP(H,green_edges, K, demand_flows, w_l, w_h, Thrh, Thr, weights):
    ...
    Max_Time,my_used_arc, my_delta, Total_Hop, Total_ReRouted,UpdateTime = optimize_SDN(H,nodes,demand_flows,green_edges,arcs,capacity,K,inflow, demand_value, w_l, w_h, Thrh, Thr, weights)
    ...
    """
    return Objective, my_delta, H, my_used_arc, Max_Time, Total_Hop, Total_ReRouted, UpdateTime#MaxCong #Deltah, Thetah, H
...
def optimize_SDN(H,nodes,demand_flows,green_edges,arcs,capacity,K,inflow, demand_value, w_l, w_h, Thrh, Thr, weights):
    ...
    if m.status == GRB.status.OPTIMAL:
        ...
        print 'MaxCongestion'
        print MaxCong
        return  Max_Time,my_used_arc, my_delta, Total_Hop, Total_ReRouted, UpdateTime #Max_Time,my_used_arc, my_delta, Total_Hop, Total_ReRouted #my_used_arc -> RR_used_arc
